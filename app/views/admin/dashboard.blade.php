...
@section("content")
	...
	<div >
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">{{ Lang::get('general.dashboard') }}</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">{{ Lang::get('messages.viewDetails') }}</span>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge" style="padding-right:5px;">{{ $usersCount }}</div>
                                    <div>{{ Lang::get('messages.usersCount') }}</div>
                                </div>
                            </div>
                        </div>
