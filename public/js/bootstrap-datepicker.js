	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                ' title="' + prevText + '">' + (isRTL ? '<span class="glyphicon glyphicon-chevron-right"></span>' : '<span class="glyphicon glyphicon-chevron-left"></span>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<span class="glyphicon glyphicon-chevron-right">' : '<span class="glyphicon glyphicon-chevron-left"></span>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<span class="glyphicon glyphicon-chevron-left"></span>' : '<span class="glyphicon glyphicon-chevron-right">') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<span class="glyphicon glyphicon-chevron-left"></span>' : '<span class="glyphicon glyphicon-chevron-right">') + '</a>'));
